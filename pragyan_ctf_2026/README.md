...
│   │   └── <a href="pwn/dirty_laundry/exploit.py">💻 Exploit</a>
│   │
...
│   │   └── <a href="pwn/pcalc/exploit.py">💻 Exploit</a>
│   │
...
│   │   └── <a href="pwn/talking_mirror/solve.py">💻 Exploit</a>
│   │
...
│       └── <a href="pwn/TerviMator/exploit_aslr.py">💻 Exploit</a>
│
├── web/
...
│   │   └── <a href="web/note_keeper/exploit.py">💻 Exploit</a>
│   │
...
│   │   └── <a href="web/server_oc/exploit.py">💻 Exploit</a>
│   │
...
│   │   └── <a href="web/picturethis/solve.py">💻 Exploit</a>
│   │
...
│   │   └── <a href="crypto/dora_nulls/solve.py">💻 Exploit</a>
│   │
...
│   │   └── <a href="crypto/R0tnoT13/solve_z3.py">💻 Exploit</a>
│   │
...
│   │   └── <a href="crypto/dum_cows/solve.py">💻 Exploit</a>
│   │
...
│       └── <a href="crypto/candles_and_cripto/exploit.py">💻 Exploit</a>
│
├── forensics/
...
│   │   └── <a href="forensics/whoami/exploit.py">💻 Exploit</a>
│   │
...
│   │   └── <a href="forensics/epstein_files/solve.py">💻 Exploit</a>
│   │
...
└── misc/
    ...
    └── <a href="misc/tac-tic-toe/WRITEUP_english.md">tac-tic-toe/</a>
        ...
        └── <a href="misc/tac-tic-toe/solve.js">💻 Exploit</a>
</pre>
