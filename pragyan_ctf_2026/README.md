...
│
├── pwn/
│   ├── <a href="pwn/dirty_laundry/WRITEUP_english.md">dirty_laundry/</a> · <a href="pwn/dirty_laundry/exploit.py">💻 Exploit</a>
│   │   ├── Binary exploitation with buffer overflow and ROP chain
│   │   └── Learn: Stack buffer overflow, ret2libc, ROP gadgets
│   ├── <a href="pwn/pcalc/WRITEUP_english.md">pcalc/</a> · <a href="pwn/pcalc/exploit.py">💻 Exploit</a>
│   │   ├── Python jail escape via chained vulnerabilities
│   │   └── Learn: F-string AST bypass, object hierarchy, audit hook bypass
│   ├── <a href="pwn/talking_mirror/WRITEUP_english.md">talking_mirror/</a> · <a href="pwn/talking_mirror/solve.py">💻 Exploit</a>
...
│   └── <a href="pwn/TerviMator/WRITEUP_english.md">TerviMator/</a> · <a href="pwn/TerviMator/exploit_aslr.py">💻 Exploit</a>
...
│   ├── <a href="web/shadow_fight/WRITEUP_english.md">shadow_fight/</a> · <a href="web/shadow_fight/exploit.py">💻 Exploit</a>
│   │   ├── XSS challenge with closed Shadow DOM bypass
│   │   └── Learn: Shadow DOM bypass, split-comment XSS, window.find()
│   ├── <a href="web/shadow_fight/WRITEUP_english.md">shadow_fight_2/</a> · <a href="web/shadow_fight/exploit_2.py">💻 Exploit</a>
│   │   ├── Advanced XSS with split-comment technique
│   │   └── Learn: Split-comment XSS (/* and */ in different params)
│   ├── <a href="web/note_keeper/WRITEUP_english.md">note_keeper/</a> · <a href="web/note_keeper/exploit.py">💻 Exploit</a>
│   │   ├── Next.js middleware bypass chain
│   │   └── Learn: CVE-2025-29927, CVE-2025-57822, middleware bypass
│   ├── <a href="web/server_oc/WRITEUP_english.md">server_oc/</a> · <a href="web/server_oc/exploit.py">💻 Exploit</a>
│   │   ├── Multi-stage web exploitation chain
│   │   └── Learn: JWT alg=none bypass, prototype pollution, SSRF
│   ├── <a href="web/picturethis/WRITEUP_english.md">picturethis/</a> · <a href="web/picturethis/solve.py">💻 Exploit</a>
...
│
├── crypto/
│   ├── <a href="crypto/dora_nulls/WRITEUP_english.md">dora_nulls/</a> · <a href="crypto/dora_nulls/solve.py">💻 Exploit</a>
│   │   ├── Cryptographic puzzle involving null bytes
│   │   └── Learn: Null byte manipulation, custom cipher analysis
│   ├── <a href="crypto/R0tnoT13/WRITEUP_english.md">R0tnoT13/</a> · <a href="crypto/R0tnoT13/solve_z3.py">💻 Exploit</a>
│   │   ├── State reconstruction from XOR-rotation leaks
│   │   └── Learn: Linear algebra over GF(2), Z3 constraint solving, ROTL
│   ├── <a href="crypto/dum_cows/WRITEUP_english.md">dum_cows/</a> · <a href="crypto/dum_cows/solve.py">💻 Exploit</a>
│   │   ├── XOR stream cipher with keystream reuse
│   │   └── Learn: Known-plaintext attack, keystream extraction
│   └── <a href="crypto/candles_and_cripto/WRITEUP_english.md">candles_and_cripto/</a> · <a href="crypto/candles_and_cripto/exploit.py">💻 Exploit</a>
...
│   ├── <a href="forensics/whoami/WRITEUP_english.md">whoami/</a> · <a href="forensics/whoami/exploit.py">💻 Exploit</a>
│   │   ├── Network forensics with NTLMv2 hash cracking
│   │   └── Learn: NTLMv2 hash extraction, hashcat, timestamp analysis
│   ├── <a href="forensics/epstein_files/WRITEUP_english.md">epstein_files/</a> · <a href="forensics/epstein_files/solve.py">💻 Exploit</a>
...
└── misc/
    ...
    └── <a href="misc/tac-tic-toe/WRITEUP_english.md">tac-tic-toe/</a> · <a href="misc/tac-tic-toe/solve.js">💻 Exploit</a>
