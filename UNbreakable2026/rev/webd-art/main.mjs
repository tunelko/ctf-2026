...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _281: (x0,x1) => x0.getContext(x1),
      _282: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._282(f,arguments.length,x0) }),
      _283: (x0,x1,x2) => x0.addEventListener(x1,x2),
      _284: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._284(f,arguments.length,x0) }),
      _285: x0 => x0.save(),
      _286: (x0,x1,x2,x3,x4) => x0.fillRect(x1,x2,x3,x4),
      _287: (x0,x1,x2,x3,x4,x5,x6) => x0.createRadialGradient(x1,x2,x3,x4,x5,x6),
      _288: (x0,x1,x2) => x0.addColorStop(x1,x2),
      _289: x0 => x0.restore(),
      _290: x0 => x0.beginPath(),
      _291: (x0,x1,x2) => x0.moveTo(x1,x2),
      _292: (x0,x1,x2,x3,x4) => x0.quadraticCurveTo(x1,x2,x3,x4),
      _293: x0 => x0.stroke(),
      _294: (x0,x1,x2,x3,x4,x5) => x0.arc(x1,x2,x3,x4,x5),
      _295: x0 => x0.fill(),
      _296: (x0,x1,x2) => x0.lineTo(x1,x2),
      _297: (x0,x1,x2,x3,x4) => x0.strokeRect(x1,x2,x3,x4),
      _298: (x0,x1,x2,x3) => x0.fillText(x1,x2,x3),
      _299: x0 => x0.closePath(),
      _300: x0 => x0.random(),
      _303: () => globalThis.Math,
      _315: Function.prototype.call.bind(Number.prototype.toString),
      _316: Function.prototype.call.bind(BigInt.prototype.toString),
      _317: Function.prototype.call.bind(Number.prototype.toString),
      _1438: x0 => x0.value,
      _1730: x0 => x0.width,
      _1732: x0 => x0.height,
      _1780: (x0,x1) => { x0.globalAlpha = x1 },
      _1788: (x0,x1) => { x0.strokeStyle = x1 },
      _1790: (x0,x1) => { x0.fillStyle = x1 },
      _1802: (x0,x1) => { x0.lineWidth = x1 },
      _1804: (x0,x1) => { x0.lineCap = x1 },
      _1812: (x0,x1) => { x0.font = x1 },
